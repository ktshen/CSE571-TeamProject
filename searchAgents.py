...
class PositionSearchProblem(search.SearchProblem):
    ...
    def isGoalState(self, state, visited=None):
        if visited is None:
...
class AStarPositionSearchAgent(SearchAgent):
    ...
    def __init__(self):
        self.searchFunction = lambda prob: search.aStarSearch(prob, positionHeuristic)
        self.searchType = PositionSearchProblem

class biDirectionalAStarPositionSearchAgent(SearchAgent):
    def __init__(self):
